    ...
    <footer className="border-t border-navy/10 py-8">
      <div className="max-w-6xl mx-auto px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-navy/40">© 2026 Kuchivaripalli Nagalinga · Aspiring Software Engineer · Andhra Pradesh, India</span>
        </div>
        <div className="flex items-center gap-6">
          <a
            ...
            className="text-xs font-medium text-navy/40 hover:text-coral transition-colors tracking-wide"
          >
            GitHub
          </a>
          <a
