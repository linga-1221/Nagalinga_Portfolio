...
export default function Hero() {
  return (
    <section className="min-h-screen flex items-center relative pt-20 overflow-hidden bg-cream">
      {/* Giant NK watermark - rotated */}
      <div className="absolute -left-20 top-1/2 -translate-y-1/2 text-[35vw] font-display text-navy/[0.03] leading-none select-none pointer-events-none -rotate-12">
        NK
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 w-full relative">
        <div className="max-w-5xl">
          ...
          >
            ...
            <span className="text-[10px] font-bold tracking-[0.35em] uppercase text-navy/30">B.Tech CSE (AI/ML) · 2026</span>
          </motion.div>
          ...
          <motion.h1
            ...
            className="relative"
          >
            <span className="block font-display text-7xl sm:text-8xl md:text-9xl lg:text-[10rem] xl:text-[11rem] leading-[0.82] text-navy tracking-tighter">
              Kuchivaripalli
            </span>
          ...
          <motion.p
            ...
            className="mt-10 text-base md:text-lg text-navy/50 max-w-lg leading-relaxed lg:ml-4"
          >
      ...
      <div className="absolute bottom-12 right-12 hidden lg:flex flex-col items-end gap-2">
        <span className="text-[10px] font-bold tracking-[0.35em] uppercase text-navy/20">Est. 2026</span>
